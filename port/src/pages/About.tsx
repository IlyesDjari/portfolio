        ...
        <>
            ...
            <div className="aboutBody">
                ...
                <div className="aboutContainer">
                    ...
                    My name is Ilyes Djari and I was born on July 3, 2002 in Etterbeek. Since I was young, I grew up in Brussels in the city of Ixelles. I was born to a Belgian mother and an Algerian father. I have always been a very creative and perfectionist person. I draw my motivation and optimism from this to achieve all the projects I undertake. In my free time, I enjoy exploring new creative pursuits and challenging myself to learn new skills. I am also passionate about learning and growing, both personally and professionally. Overall, I am a driven and ambitious individual with a strong desire to make a positive impact in the world.
                    </p>

                    <p className="aboutDescription">
                        I thought for a long time that I was destined to become a sound engineer. Since I was little I had my nose in my parents' vinyl. Music was an entire part of my life at all times. And what better than reading a good book with a smooth sound of Lo Fi Hip Hop in the background? Music has always been an essential factor in allowing me to study with a big smile. So in 2020, I obtained my ASO diploma at Atheneum Brussel in modern languages, mathematics, and science. Very quickly I also became interested in beat making & mixing. I spent night and day learning these arts. I then quickly established contacts with several pillars of the hip-hop scene in Brussels. Until this day I mix for others and I create new beats. Besides that, I’m a fully independent artist too.
                    </p>
                    <p className="aboutDescription">
